...
class Perfil extends Component {
    ...
    logout() {
        localStorage.clear();
        window.location.href = './Apresentacao.js';
    }
    atualizaSenha(event) {
                                        ...
                                        <form>
                                            <div id="pord-div-4-flex-perf">
                                                ...
                                                <div id="pord-div-5-input-perf">
                                                    ...
                                                    <input value={this.state.senha} onChange={this.atualizaSenha} required type="password" /></div>
                                            </div>
                                            <div id="pord-div-5-btn-perf">
                                                <button onClick={this.alterarSenha} type="submit">Confirmar</button> <button onClick={this.mostrar}>Voltar</button>
                                            </div>
                                        </form>
                                    </div>
