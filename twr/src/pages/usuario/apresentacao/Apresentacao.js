                ...
                <body>
                    <header id="topo-apresentacao"> 
                        <nav class="menu-apresentacao">
                            ...
                            <ul id="ul-apresentacao"> 
                                <Link to={'/login'}> <button class="button-apresentacao-nt"><span>Entrar</span></button></Link> 
                            </ul>
                        </nav> 
                    </header> 
                    ...
                    <section id="primeira-section-apresentacao"> 
                        <div class="itens-apresentacao-um"> 
                            ...
                            Já que não é possível faturar financeiramente com a substituição de ativos, muitas empresas optam por trocar suas máquinas mais antigas por uma moeda menos tangível.
                            </p>
                        </div> 
                    </section>   
